...
- Минахме през основен увод в Nix езикът
- Минахме през основен увод в пакетирането на програми чрез Nix
- Разгледахме и употребявахме `nix-build`, `nix-shell`, `nix-instantiate`, `nix-store`
...
- Операции извън програмата (обработка на файлове, шел променливи, ...) са сложни
...
- Добре познати; ресурсите и библитеките не са толкова много, но са достатъчно
- Невъзпороизводим код е много труден за писане
...
- Функциите са "first-class citizen" (третират се като обикновенни стойности)
...
- За да разграничим кои шпации са част от "тялото" на функцията и кои извън, ограждаме с кръгли скоби
  ...
  Това важи и когато фукцията е елемент на списък
...
- Аналогично получваме грешка ако аргументи липсват.
  Можем да зададем стойности по подразибране чрез `?`.
...
# Функционално програмиране чрез `builtins`

<!-- TODO(reo101): Увод във функционалното програмиране чрез builtins -->
